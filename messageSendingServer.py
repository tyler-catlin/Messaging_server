# A messaging server that takes multiple special arguments to do things such as message privately, list users, or votekick users
...
def spam_filter(new_message):
    ...
    spam_const = 20   #make this however long you want, longer = less easy to spam the same message
